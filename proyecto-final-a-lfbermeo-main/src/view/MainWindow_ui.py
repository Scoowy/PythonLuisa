...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spbRange = QtWidgets.QSpinBox(self.groupBox)
        self.spbRange.setGeometry(QtCore.QRect(210, 30, 42, 22))
        self.spbRange.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.spbRange.setReadOnly(False)
        self.spbRange.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        self.spbRange.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectToNearestValue)
        self.spbRange.setKeyboardTracking(False)
        self.spbRange.setMinimum(1)
        self.spbRange.setMaximum(15)
        self.spbRange.setSingleStep(1)
        self.spbRange.setObjectName("spbRange")
